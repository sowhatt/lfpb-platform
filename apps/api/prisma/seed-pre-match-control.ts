...
const KICKOFF = new Date('2026-10-11T16:00:00.000Z');
...
async function main() {
  ...
  console.info('DRAGONS=11 joueurs à contrôler');
  console.info('AZIZA=11 joueurs à contrôler');
  console.info('CONTROLES=0/22');
}
